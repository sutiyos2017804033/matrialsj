        ...
        <table border="0" align="center" style="width:800px; border:none;margin-top:5px;margin-bottom:0px;">
            <tr>
                <td colspan="2" style="width:800px;paddin-left:20px;">
                    <center>
                        <h4>LAPORAN PENJUALAN PERTAHUN <?php echo $b['tahun']; ?></h4>
                    </center><br />
                </td>
            </tr>
            <tr>
        ...
        <table border="1" align="center" style="width:900px;margin-bottom:20px;">
            ...
            foreach ($data->result_array() as $d) {
                ...
                if ($group == '-' || $group != $d['bulan']) {
                    $bulan = $d['bulan'];
                    $query = $this->db->query("SELECT jual_notrans,DATE_FORMAT(jual_tanggal,'%M %Y') AS bulan,DATE_FORMAT(jual_tanggal,'%d %M %Y') AS jual_tanggal,d_jual_barang_id,d_jual_barang_nama,d_jual_barang_satuan,d_jual_barang_harpok,d_jual_barang_harjul,d_jual_qty,d_jual_diskon,SUM(d_jual_total) AS total FROM tbl_jual JOIN tbl_detail_jual ON jual_notrans=d_jual_notrans WHERE DATE_FORMAT(jual_tanggal,'%M %Y')='$bulan'");
                    $t = $query->row_array();
                    $tots = $t['total'];
                    if ($group != '-')
                        echo "</table><br>";
    ...
    <td width='10%' align='center'>Subtotal</td>
            ...
            ?>
                <tr>
                    ...
                    <td style="vertical-align:top;padding-left:5px;"><?php echo $d['jual_notrans']; ?></td>
