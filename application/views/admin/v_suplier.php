...
<body>
    ...
    <div class="col-lg-12">
        <h1 class="page-header">Data Supplier
            <div class="pull-right"><a style="background-color:black;" href="#" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#largeModal"><span class="fa fa-plus"></span> Tambah Suplier</a>
            </div>
        </h1>
    </div>
    </div>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <a class="btn btn-xs btn-success" href="#modalEditPelanggan<?php echo $id ?>" data-toggle="modal" title="Edit"><span class="fa fa-edit"></span> Edit</a>
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/suplier/tambah_suplier' ?>">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <input name="notelp" class="form-control" type="number" maxlength="13" placeholder="No Telp/HP..." style="width:280px;" required>
                            </div>
                        </div>
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/suplier/edit_suplier' ?>">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-3">No Telp/ HP</label>
                                <div class="col-xs-9">
                                    <input name="notelp" class="form-control" maxlength="13" type="number" placeholder="No Telp/HP..." value="<?php echo $notelp; ?>" style="width:280px;" required>
                                </div>
                            </div>
