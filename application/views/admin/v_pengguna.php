    ...
    <div class="col-lg-12">
        ...
        <h3 class="page-header">Data Pengguna
            <div class="pull-right">
                <a href="#" style="background-color:black;" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#largeModal"><span class="fa fa-plus"></span> Tambah Pengguna</a>
            </div>
        </h3>
    </div>
    </div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td> <input style="border:0;" type="password" value="<?php echo $password; ?>" readonly></td>
    ...
    <footer>
        <div class="row">
            <div class="col-lg-12">
                ...
                ?>
                <p style="text-align:center;">Copyright &copy; <?= $date; ?> Toko Bangunan Suci Jaya</p>
            </div>
        </div>
        <!-- /.row -->
    </footer>
