...
<body>
    ...
    <div class="col-lg-12">
        <h1 class="page-header">Barang
            <div class="pull-right"><a style="background-color: black;" href="#" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#largeModal"><span class="fa fa-plus"></span>Tambah</a></div>
        </h1>
    </div>
    </div>
    <!-- /.row -->
